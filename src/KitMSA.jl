...
extended_cod2amino = Dict( "ATA" => Int8(8), "ATC" => Int8(8), "ATT"=> Int8(8), "ATG"=> Int8(11), 
        "ACA"=>Int8(17), "ACC"=>Int8(17), "ACG"=>Int8(17), "ACT"=> Int8(17), 
        "AAC"=>Int8(12), "AAT"=>Int8(12), "AAA"=>Int8(9), "AAG"=>Int8(9), 
        "AGC"=>Int8(16), "AGT"=> Int8(16), "AGA"=> Int8(15), "AGG"=> Int8(15),                  
        "CTA"=>Int8(10), "CTC"=>Int8(10), "CTG"=>Int8(10), "CTT"=>Int8(10), 
...
for i in 1:5
    for j in 1:5
        for k in 1:5
            combination = bases[i] * bases[j] * bases[k]
            if contains(combination, "-")
                extended_cod2amino[combination] = Int8(21)
            end
        end
    end
end

extended_amino2cod = Dict()
for amino in 1:21
    codons = Array{String, 1}()
    for (key, val) in extended_cod2amino
       val == amino && push!(codons, key)
    end
    extended_amino2cod[amino] = codons
end

export cod2amino, amino2cod, extended_cod2amino, extended_amino2cod
